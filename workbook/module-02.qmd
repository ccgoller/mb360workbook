...
![Figure 2.1. Single-colony transfer onto a fresh TSA plate for streaking practice.](images/template/image13.png){#fig-module2-streaking fig-alt="Diagram showing a sterile loop transferring a single colony onto a fresh agar plate for streaking."}
