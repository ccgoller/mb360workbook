...
![Single-colony transfer onto a fresh TSA plate for streaking practice. Created with BioRender.com.](images/module-02/PlateStreaking.png){#fig-module2-streaking fig-alt="Diagram showing a sterile loop transferring a single colony onto a fresh agar plate for streaking practice."}
...
![Correct placement of labels on the bottom of a TSA plate. Created with BioRender.com.](images/module-02/PlateLabeling.png){#fig-module2-labeling fig-alt="Diagram showing how to label the bottom of an agar plate with isolate name, section, group number, and date."}
