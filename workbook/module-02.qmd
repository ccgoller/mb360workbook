...
![Single-colony transfer onto a fresh TSA plate for streaking practice.](images/module-02/PlateStreaking.png){#fig-module2-streaking fig-alt="Diagram showing a sterile loop transferring a single colony onto a fresh agar plate for streaking."}
...
![Correct placement of labels on the bottom of a TSA plate.](images/module-02/PlateLabeling.png){#fig-module2-labeling fig-alt="Diagram showing how to label the bottom of an agar plate with isolate name, class section, and date."}
