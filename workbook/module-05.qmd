...
:::{.slide-link}
[{{< bi easel2 >}} View Slide Deck](slides/module-05-slides.html){.btn target="_blank" rel="noopener noreferrer" aria-label="Open Module 5 slide deck in a new tab"}
:::
...
![Cerillo Duet co-culture layout with isolate-only, control, and co-culture conditions.](images/template/image14.png){#fig-module5-duet-layout fig-alt="Diagram of a Cerillo Duet co-culture plate with paired chambers for controls and co-culture conditions."}
