...
![Figure 3.1. Blank 96-well plate layout for planning growth-curve wells and controls.](images/template/image10.png){#fig-module3-growth-layout fig-alt="Blank 96-well plate diagram for organizing growth-curve and control conditions."}

- Prepare 1:1000 dilutions of the overnight cultures.
- Use positive and negative controls.
- Pour diluted cultures into sterile reservoirs.
- Use a multichannel pipette to add 100 uL to the assigned 96-well plate columns.
...
- Seed the assigned wells with 100 uL per well.
...
![Figure 3.2. Biofilm viability workflow using wash plates and detection reagent.](images/template/image1.png){#fig-module3-biofilm-viability fig-alt="Workflow diagram showing peg-lid washing steps followed by incubation in detection reagent for a biofilm viability assay."}
