...
![Micropipette volume display used for introductory pipetting practice.](images/template/image7.png){#fig-module1-pipette fig-alt="Illustration of a micropipette with the volume display highlighted for reading the setting."}
...
Serial dilution is the stepwise dilution of a solution by a constant factor. In this module, you will perform a 1:10 serial dilution of crystal violet in a 96-well plate to connect pipetting technique to concentration changes.

Figure @fig-module1-serial-overview summarizes the repeated transfer logic behind the serial dilution workflow.

![Serial dilution overview showing stepwise dilution from a concentrated starting sample.](images/template/image15.jpg){#fig-module1-serial-overview fig-alt="Diagram showing a serial dilution sequence with decreasing dye concentration."}

### Protocol

Use Figure @fig-module1-microplate to plan the first rows of the microplate before starting the transfers.

![Top rows of a 96-well microplate used to plan the serial dilution setup.](images/template/image11.jpg){#fig-module1-microplate fig-alt="Photo of the top rows of a 96-well microplate used as a planning template."}

1. Add 50 µL of water to each well in row A.
2. Add 50 µL of crystal violet to well A1.
3. Mix A1 gently, then transfer 50 µL from A1 to A2.
4. Repeat across row A through A12.
5. Discard the final 50 µL after mixing A12.
6. Repeat the same process for rows B, C, and D as assigned between partners.
7. Add 100 µL of water to well H12 as a negative control.
...
![Blank 96-well plate template for planning and annotation.](images/template/image10.png){#fig-module1-plate-template fig-alt="Blank 96-well plate diagram labeled by row and column for planning experiments."}

:::{.callout-important}
Note that you will need to respond to the questions below as part of your ELN entry, so consider them as you plan your workflow.
:::
...
:::{.callout-note}
Note that each module will have a set of reflection questions to help you connect the activities to the learning outcomes. You will need to answer these questions in your ELN entry, so consider them carefully.
:::
