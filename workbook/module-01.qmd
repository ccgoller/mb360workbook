...
![Micropipette volume display used for introductory pipetting practice.](images/module-01/micropipette-volume-display.png){#fig-module1-pipette fig-alt="Illustration of a micropipette with the volume display highlighted for reading the setting."}
...
![Serial dilution overview showing stepwise dilution from a concentrated starting sample.](images/module-01/serial-dilution-overview.jpg){#fig-module1-serial-overview fig-alt="Diagram showing a serial dilution sequence with decreasing dye concentration."}

### Protocol

Use Figure @fig-module1-microplate to plan the first rows of the microplate before starting the transfers.

![Top rows of a 96-well microplate used to plan the serial dilution setup.](images/module-01/serial-dilution-microplate-plan.jpg){#fig-module1-microplate fig-alt="Photo of the top rows of a 96-well microplate used as a planning template."}
