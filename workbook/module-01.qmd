...
:::{.slide-link}
[{{< bi easel2 >}} View Slide Deck](slides/module-01-slides.html){.btn target="_blank" rel="noopener noreferrer" aria-label="Open Module 1 slide deck in a new tab"}
:::
...
![Serial dilution overview showing stepwise dilution from a concentrated starting sample.](images/template/image15.jpg){#fig-module1-serial-overview fig-alt="Diagram showing a serial dilution sequence from a concentrated source through progressively diluted samples."}

### Protocol

Use Figure @fig-module1-microplate to plan the first rows of the microplate before starting the transfers.

![Top rows of a 96-well microplate used to plan the serial dilution setup.](images/template/image11.jpg){#fig-module1-microplate fig-alt="Photo of the top rows of a 96-well microplate used as a planning guide for serial dilution."}
...
![Blank 96-well plate template for planning and annotation.](images/template/image10.png){#fig-module1-plate-template fig-alt="Blank 96-well plate diagram labeled by row and column for planning experimental layouts."}
...
:::{.callout-note}
Note that each module will have a set of reflection questions to help you connect the activities to the learning outcomes. You will need to answer these questions in your ELN entry, so consider them as you work through the activity.
:::
