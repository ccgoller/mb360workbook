...
![Nanopore sequencing and downstream analysis workflow.](images/module-06/nanopore-sequencing-analysis-workflow.png){#fig-module6-sequencing-overview fig-alt="Workflow diagram showing nanopore sequencing followed by basecalling, assembly, and genome exploration."}
...
![Qubit fluorometer workflow for DNA quantification.](images/module-06/qubit-dna-quantification-workflow.png){#fig-module6-qubit fig-alt="Workflow diagram showing preparation of a Qubit assay tube and fluorometer-based DNA quantification."}

Figure @fig-module6-library-prep summarizes the rapid barcoding library-preparation workflow used before sequencing.

![Nanopore rapid barcoding workflow for sequencing library preparation.](images/module-06/nanopore-rapid-barcoding-workflow.png){#fig-module6-library-prep fig-alt="Workflow diagram showing the rapid barcoding steps used to prepare DNA for nanopore sequencing."}
