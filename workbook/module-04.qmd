...
:::{.slide-link}
[{{< bi easel2 >}} View Slide Deck](slides/module-04-slides.html){.btn target="_blank" rel="noopener noreferrer" aria-label="Open Module 4 slide deck in a new tab"}
:::
...
![Biolog GEN III plate layout with carbon-source and control wells.](images/template/image3.png){#fig-module4-biolog-layout fig-alt="Biolog GEN III plate layout showing the distribution of test conditions across the wells."}
...
![Loading a Biolog GEN III plate with a multichannel pipette.](images/template/image8.png){#fig-module4-biolog-loading fig-alt="Illustration showing a multichannel pipette transferring inoculum into a 96-well Biolog plate."}

Figure @fig-module4-biolog-incubation shows the expected appearance of an inoculated Biolog plate after incubation.

![Biolog GEN III plate after incubation with visible growth response.](images/template/image9.png){#fig-module4-biolog-incubation fig-alt="Illustration of a Biolog GEN III plate with several purple wells indicating post-incubation growth response."}
