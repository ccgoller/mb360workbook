...
![Three-phase streak pattern for isolating single colonies on TSA plates.](../images/module-02/PlateStreaking.png){fig-alt="Diagram of a three-phase streak pattern on an agar plate for bacterial isolation." style="max-height:260px; display:block; margin:0 auto;"}
