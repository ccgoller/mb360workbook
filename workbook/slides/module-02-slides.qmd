...
![Single-colony transfer onto a fresh TSA plate for streaking practice.](../images/module-02/PlateStreaking.png){fig-alt="Diagram showing a sterile loop transferring a single colony onto a fresh agar plate for streaking." style="max-height:260px; display:block; margin:0 auto;"}
...
![Correct placement of labels on the bottom of a TSA plate.](../images/module-02/PlateLabeling.png){fig-alt="Diagram showing how to label the bottom of an agar plate with isolate name, class section, and date." style="max-height:260px; display:block; margin:0 auto;"}
